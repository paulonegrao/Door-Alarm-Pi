...
const pushButtonARN = '/doorSensor/sns_arn'; // AWS Parameter Store for this pushButton ARN
...
async function fMain() {
  try {  // try to execute
    ...
    let parameter = awsParamStore.getParameterSync(`${pushButtonARN}`, { region: myRegion });
